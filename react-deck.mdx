...
## Why React?
- What if your view <p style={{fontStyle: "italic", display:"inline"}}>reacted</p> to changes to your data?
- What if you could speed up manipulations to the DOM?
- What if your code was organized like your UI is?

---

## A more "reactive" experience
